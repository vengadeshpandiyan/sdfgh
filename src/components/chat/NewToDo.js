        ...
        <div i={i}>
            ...
            <div>
              ...
              <div className='btn_close'>
                <button onClick={(e)=>addTodo(e,InputValues,i,setAddtodo)} className='add_btn'>Add</button>
                <div className='closeicon'><CloseIcon  onClick={()=>{setAddtodo(false)}}></CloseIcon></div>
              </div>
            </div>
            :
            <div className='card_button'>
              <button onClick={()=>setAddtodo(true)}><span className='card_plus'>+</span> Add another card</button>
